...
import static edu.bt.quizadmin.CategoryActivity.catList;
import static edu.bt.quizadmin.CategoryActivity.selected_cat_index;
import static edu.bt.quizadmin.SetsActivity.selected_set_index;
import static edu.bt.quizadmin.SetsActivity.setsIDs;
        ...
        firestore.collection("QUIZ").document(catList.get(selected_cat_index).getId())
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        Map<String, QueryDocumentSnapshot> docList;
                        docList = new ArrayMap<>();
